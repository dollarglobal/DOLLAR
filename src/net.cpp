...
bool GetMyExternalIP(CNetAddr& ipRet)
{
    ...
    for (int nHost = 1; nHost <= 2; nHost++)
    {
        ...
        if (nHost == 1)
        {
            addrConnect = CService("23.228.68.61",80); // checkip.dyndns.org
        ...
        {
            addrConnect = CService("23.228.68.61", 80); // www.showmyip.com
...
static const char *strDNSSeed[][2] = {
       ...
       {"seed.edollar.international", "seed.edollar.international"},
    // {"dollarcoinpool.org", "dnsseed.dollarcoinpool.org"},
...
void ThreadOpenAddedConnections(void* parg)
{
    ...
    // Make this thread recognisable as the connection opening thread
    RenameThread("dollarcoin-opencon");
