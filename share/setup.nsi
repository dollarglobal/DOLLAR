...
!define COMPANY "Dollarcoin project"
!define URL http://www.edollar.international/
...
!define MUI_FINISHPAGE_RUN $INSTDIR\dollarcoin-qt.exe
...
OutFile dollarcoin-0.7.9-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/dollarcoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/dollarcoind.exe
    ...
    Delete /REBOOTOK $INSTDIR\dollarcoin.exe
...
Section -post SEC0001
    ...
    WriteRegStr HKCR "litecoin\DefaultIcon" "" $INSTDIR\dollarcoin-qt.exe
    WriteRegStr HKCR "litecoin\shell\open\command" "" '"$INSTDIR\dollarcoin-qt.exe" "$$1"'
SectionEnd
